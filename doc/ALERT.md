...
`pgexporter` includes a built-in alert system that monitors the health of your
[PostgreSQL](https://www.postgresql.org) instances and exposes alert states as Prometheus metrics.
...
[Grafana Dashboard](manual/en/09-grafana.md).
