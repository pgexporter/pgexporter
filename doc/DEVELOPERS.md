...
``` sh
dnf install git gcc clang clang-analyzer clang-tools-extra cmake make libev libev-devel openssl openssl-devel systemd systemd-devel libyaml libyaml-devel python3-docutils libatomic zlib zlib-devel libzstd libzstd-devel lz4 lz4-devel bzip2 bzip2-devel libasan libasan-static
```
...
1. Download dependencies
    ...
    ``` sh
    dnf install pandoc texlive-scheme-basic texlive-xetex
    ```
