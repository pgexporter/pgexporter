...
## Running with docker
Follow [this](./doc/manual/en/14-docker.md) to build using docker
...
```
dnf install git gcc clang clang-analyzer clang-tools-extra cmake make liburing-devel pkgconf openssl openssl-devel systemd systemd-devel python3-docutils libyaml libyaml-devel zlib zlib-devel libzstd libzstd-devel lz4 lz4-devel bzip2 bzip2-devel libasan libasan-static
```
...
or version-specific package if available
